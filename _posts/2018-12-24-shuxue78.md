---
layout: post
title:  "深度学习入门（十一）一周精读论文与代码复刻 ArcFace (Day 2)"
date:   2018-12-15
categories: 算法与数学
excerpt: 嗯
---
...
原论文中只是说效果比较好，我看了网上的说法，说$\cos(\theta + m) = \cos\theta \cos m - \sin\theta \sin m$，相比于Cosine Margin Loss中的$\cos\theta -t$，不仅动态依赖$\sin\theta$，还能使得网络学到更多的角度特性。
